...
behavior that they deem inappropriate, threatening, harmful,
or offensive.
...
(both online and offline), and also applies when an
individual is officially representing the community in
public spaces. Examples of representing our community
include using an official e-mail address, posting via an
...
responsible for enforcement. All complaints will be reviewed
...
Guidelines in determining the consequences of any action
...
including unsolicited interaction with those enforcing the
Code of Conduct, for a specified period of time. This
includes avoiding interactions in community spaces as well
as external channels like social media. Violating these
